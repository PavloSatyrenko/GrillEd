...
export const routes: Routes = [
    ...
    { path: "profile/student", loadComponent: () => import("./profile/profile.component").then(c => c.ProfileComponent), canActivate: [canActivateGuard] },
    { path: "profile/teacher", loadComponent: () => import("./profile/profile.component").then(c => c.ProfileComponent), canActivate: [canActivateGuard] },
    { path: "course/create", loadComponent: () => import("./course-editing/course-editing.component").then(c => c.CourseEditingComponent), canActivate: [canActivateGuard] },
